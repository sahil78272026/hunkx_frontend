...
export default function CheckoutPage() {
  ...
  // Pre-fill email and name, and fetch default address if available
  useEffect(() => {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (defaultAddress) {
            setFormData(prev => ({
              ...prev,
              mobile: defaultAddress.mobile || prev.mobile,
              address: `${defaultAddress.street_address}, ${defaultAddress.city}, ${defaultAddress.state}`,
